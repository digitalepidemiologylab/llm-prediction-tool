...
ActiveRecord::Schema[8.0].define(version: 2025_03_06_143300) do
  ...
  create_enum "provider", ["anthropic", "azure", "openai", "gemini", "huggingface"]
  create_enum "result_status", ["initial", "processing", "ready", "failed", "cancelled"]
  ...
  create_table "datasets", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "column_separator", limit: 1, default: ",", null: false
  ...
  create_table "experiments", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["llm_id"], name: "index_experiments_on_llm_id"
  end

  create_table "llms", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.enum "provider", null: false, enum_type: "provider"
    t.string "name", null: false
    ...
    t.uuid "deployed_by_user_id"
    t.string "host"
    t.index ["created_at"], name: "index_llms_on_created_at"
    t.index ["deployed_by_user_id"], name: "index_llms_on_deployed_by_user_id"
    t.index ["deprecated_at"], name: "index_llms_on_deprecated_at", where: "(deprecated_at IS NULL)"
  end

  create_table "results", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "experiment_id", null: false
    t.enum "status", default: "initial", null: false, enum_type: "result_status"
    t.jsonb "data", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "experiments", "llms"
  add_foreign_key "llms", "users", column: "deployed_by_user_id"
